...
namespace cavka
{
    ...
    class Program
    {
        ...
        public static int TryPress()
        {
            ...
            else { Console.ForegroundColor = ConsoleColor.Red; Console.WriteLine("Wrong input try again!"); Console.ResetColor(); return TryPress(); }
        }
        public static string Alphabet()
        {
            ...
            do
            {
                ...
                foreach (char i in x)
                {
                    ...
                    else { Console.ForegroundColor = ConsoleColor.Red; Console.WriteLine("Wrong name input again!"); Console.ResetColor(); check = false; break; }
